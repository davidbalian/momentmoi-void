...
export default function EventSetupPage() {
  ...
  const checkExistingEvent = async () => {
    try {
      ...
      if (data) {
        ...
        router.push("/dashboard/client/event");
      }
    } catch (error) {
  ...
  const createInitialChecklist = async (eventId: string, eventType: string) => {
    ...
    const template = checklistTemplates[eventType as keyof typeof checklistTemplates] || checklistTemplates.other;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-text-secondary mb-6">
          This will help us customize your planning experience and provide relevant
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-text-secondary mb-6">
          ...
          together. They'll have access to all event details and can contribute to
          planning tasks.
        </p>
      </div>
